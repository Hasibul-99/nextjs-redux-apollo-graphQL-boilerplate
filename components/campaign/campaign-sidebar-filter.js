...
function CampaignSidebarFilter( props ) {
    ...
    let sidebarData = demoSidebarData; //data && data.shopSidebarData;
    let timerId;
            ...
            <div className="sidebar-content">
                {
                    !loading && sidebarData ?
                        <div className="sticky-sidebar">
                                            ...
                                            <div className="filter-actions">
                                                ...
                                                <div className="row justify-content-between mb-0">
                                                    <div className="col-xs-4"> 
                                                        <input type="text" className="form-control" name="first-name" required="" placeholder="Max" />
                                                    </div>
                                                    <div className="col-xs-4"> 
                                                        <input type="text" className="form-control" name="phone" required="" placeholder="Min" />
                                                    </div> 
                                                </div>

                                                <button className="btn btn-filter btn-rounded" onClick={ filterByPrice }>Filter</button>
                            ...
                            <div className="widget widget-collapsible">
                                <Card title="<h3 class='widget-title'>Services<span class='toggle-btn p-0 parse-content'></span></h3>" type="parse" expanded={ true }>
                                    <ul className="widget-body filter-items">
                                        <li>
                                            <ALink scroll={ false } href="#">Cash on delivery</ALink>
                                        </li>  
                                        <li>
                                            <ALink scroll={ false } href="#">Online payment</ALink>
                                        </li>        
                                    </ul>
                                </Card>
                            </div>
                            ...
                            <div className="widget widget-collapsible">
                                <Card title="<h3 class='widget-title'>Ratings<span class='toggle-btn p-0 parse-content'></span></h3>" type="parse" expanded={ true }>
                                    <ul className="widget-body filter-items">
                                        <div className="ratings-container mb-0 font-15 pb-2">
                                        ...
                                        <div className="ratings-container mb-0 font-15 pb-2">
                                            ...
                                            <small className="font-13 and-up ml-1">And Up</small> 
                                        </div>   
                                        <div className="ratings-container mb-0 font-15 pb-2">
                                            <div className="ratings-full" style={{color:'orange'}}>
