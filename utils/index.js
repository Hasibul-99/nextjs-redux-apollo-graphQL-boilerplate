...
export const originalPriceFromCart = cart => {
    if (cart) {
        ...
        if (productVariation) {
            if (productVariation?.campaignPrice?.discount_price) {
                return productVariation?.campaignPrice?.discount_price;
            } else if ( canShowSpecialPrice(productVariation) ) {
                return canShowSpecialPrice(productVariation);
